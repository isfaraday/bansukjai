        ...
        <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch flex-grow-1" id="#kt_header_menu" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    ...
                    <div class="menu-item">
                        <a class="menu-link active py-3" href="<?php echo site_url('invoices/adds/'); ?>">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
...
<div class="toolbar py-5 py-lg-7" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder my-1 fs-3">สร้างใบแจ้งหนี้ (Invoice)</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
    </div>
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                ...
                <div class="card-title m-0">
                    <h3 class="fw-bolder m-0">ใบแจ้งหนี้</h3>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="kt_account_profile_details_form" class="form" action="<?php echo site_url('invoices/adding'); ?>" method="post">
                    <!--begin::Card body-->
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="bills_pay" class="form-control form-control-lg form-control-solid" placeholder="" value="<?php echo date('Y-m-d'); ?>" />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <select name="unit1" id="unit1" data-control="select2" data-placeholder="มิเตอร์ไฟฟ้าจากวันที่ (เลขมิเตอร์)" class="form-select form-select-solid form-select-lg">
                                            <option value="">มิเตอร์ไฟฟ้าจากวันที่ (เลขมิเตอร์)</option>
                                        </select>
                                        <!--begin::Hint-->
                                    ...
                                    <div class="col-lg-6 fv-row">
                                        ...
                                        <select name="unit2" id="unit2" data-control="select2" data-placeholder="มิเตอร์ไฟฟ้าถึงวันที่ (เลขมิเตอร์)" class="form-select form-select-solid form-select-lg">
                                            <option value="">มิเตอร์ไฟฟ้าถึงวันที่ (เลขมิเตอร์)</option>
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                        ...
                        <div class="notice d-flex bg-light-warning p-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-6 fv-row">
                                        <input type="number" name="unit" id="unit" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="x บาทต่อหน่วย" value="" min="0" />
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-lg-6 fv-row">
                                        <input type="hidden" name="bills_electric" class="form-control form-control-lg form-control-solid" placeholder="xx.xx บาท" value="" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="col-lg-6 fv-row">
                                        <input type="text" name="other" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="เว้นว่างได้" value="" />
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col-lg-6 fv-row">
                                        <input type="number" name="bills_other" class="form-control form-control-lg form-control-solid" placeholder="xx.xx บาท" value="" />
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <input type="hidden" name="bills_result" class="form-control form-control-lg form-control-solid" placeholder="xx.xx บาท" value="" readonly />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        <input type="hidden" name="bills_status" value="0" />
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">สร้างใบแจ้งหนี้</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
