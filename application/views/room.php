    ...
    <div class="header-menu container-xxl flex-column align-items-stretch flex-lg-row" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
        ...
        <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch flex-grow-1" id="#kt_header_menu" data-kt-menu="true">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item here show menu-lg-down-accordion me-lg-1">
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    <div class="menu-item">
                        <a class="menu-link active py-3" href="<?php echo base_url('room') ?>">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">ห้องพัก</span>
...
<div class="toolbar py-5 py-lg-7" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder my-1 fs-3">ห้องพัก</h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
    </div>
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">ห้องพักทั้งหมด</span>
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted bg-light">
                                    ...
                                    <th class="min-w-150px">ประเภทห้อง</th>
                                    <th class="min-w-150px">ราคาห้องพัก</th>
                                    <th class="min-w-200px">รายละเอียดเพิ่มเติม</th>
                                    <th class="min-w-200px">สถานะห้อง</th>
                            ...
                            <?php foreach ($query as $row) { ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $row->roomtype_name; ?></a>
                                        </td>
                                        <td>
                                            <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $row->roomtype_rate; ?> บาท</a>
                                        </td>
                                        <td>
                                            <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php echo $row->room_details; ?></a>
                                        </td>
                                        <td>
                                            <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6"><?php if ($row->room_status == '1') {
                                                                                                                    echo "ว่าง";
                                        ...
                                        <td class="text-end">
                                            <a href="<?php echo site_url('room/elect/') . $row->room_id; ?>" class="btn btn-success btn-color-white btn-active-light-primary btn-sm px-4 me-2">เลขมิเตอร์ไฟฟ้า</a>
                                            <a href="<?php echo site_url('room/del/') . $row->room_id; ?>" onclick="return confirm('ยืนยัน')" class="btn btn-danger btn-active-light-primary btn-sm px-4 me-2">ลบห้อง</a>
                                            <a href="<?php echo site_url('room/edit/') . $row->room_id; ?>" class="btn btn-bg-light btn-color-muted btn-active-light-primary btn-sm px-4 me-2">ดูข้อมูล</a>
                                            <a href="<?php echo site_url('room/booking/') . $row->room_id; ?>" class="btn btn-bg-primary btn-color-white btn-active-light-primary btn-sm px-4">จองห้องพัก</a>
                                        </td>
                                </tbody>
                                <!--end::Table body-->
                            <?php } ?>
